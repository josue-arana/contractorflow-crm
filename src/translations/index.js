...
export const statusKeyMap = {
  'New Lead': 'newLead', Lead: 'lead', Contacted: 'contacted', 'Estimate Sent': 'estimateSent', 'Contract Sent': 'contractSent', 'Invoice Sent': 'invoiceSent', Won: 'won', Scheduled: 'scheduled', 'In Progress': 'inProgress', 'Waiting on Client': 'waitingOnClient', 'Waiting on Materials': 'waitingOnMaterials', 'Ready for Final Walkthrough': 'readyForFinalWalkthrough', Completed: 'completed', Paid: 'paidStatus', Signed: 'signed', High: 'priorityHigh', Medium: 'priorityMedium', Low: 'priorityLow', Complete: 'completed', Upcoming: 'upcoming', Pending: 'pending', Draft: 'draft', Available: 'available', Due: 'due', 'Needs Review': 'needsReview', 'Final Balance Due': 'finalBalanceDue', 'Paid in Full': 'paidInFull', 'Progress Payment Paid': 'progressPaymentPaid', 'Deposit Paid': 'depositPaidStatus', 'Not Paid': 'notPaid', 'Not Signed': 'notSigned', 'Not generated': 'notGenerated', Approved: 'approved', Rejected: 'rejected', Sent: 'sent', 'Converted to Contract': 'convertedToContract', Overdue: 'overdue', Canceled: 'canceled', 'Site Visit': 'siteVisit', 'Project Start': 'projectStart', 'Payment Due': 'paymentDue', 'Material Delivery': 'materialDelivery', Inspection: 'inspection', 'Final Walkthrough': 'finalWalkthrough', Other: 'other', Archived: 'archived', 'Partially Paid': 'partiallyPaid'
}
